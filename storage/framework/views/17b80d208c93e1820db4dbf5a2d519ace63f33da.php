     ...
     <select class="form-control" id="exampleFormControlSelect1">
      <?php $__currentLoopData = $filter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option selected hidden value="0">FROM</option>
            <option value="<?php echo e($val->year); ?>"> School Year <?php echo e($val->year); ?></option>
...
<?php $__env->startSection('script'); ?>
     ...
     <script type="text/javascript" src="<?php echo e(asset('public/assets/js/filterstudents.js')); ?>"></script>
     <script type="text/javascript" src="<?php echo e(asset('public/assets/js/filterstudents-extension.js')); ?>"></script>
     <script type="text/javascript" src="<?php echo e(asset('public/assets/js/dropDown.js')); ?>"></script>
